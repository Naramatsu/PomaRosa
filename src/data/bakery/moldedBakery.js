...
export const WHOLE_WHEAT_SOURDOUGH_TITLE = {
  [SPANISH]: "Masa madre integral",
...
export const WHITE_SOURDOUGH_TITLE = {
  [SPANISH]: "Masa madre blanca",
  [ENGLISH]: "White sourdough",
};

export const whiteSourdoughProductList = [
  {
    name: {
      [SPANISH]: "Natural",
      [ENGLISH]: "Natural",
